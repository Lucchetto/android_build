...
####################################################
####################################################
## * * * PureFusionOS [Updated: 11/10/2017] * * * ##
####################################################
####################################################
...
DISABLE_POLLY_arm64 := \
  $(DISABLE_POLLY_arm) libjpeg_static libicuuc libwebp-decode libwebp-encode libpdfiumfxge libskia_static libaudioutils libpdfium% \
  libLLVMSupport libsvoxpico libRS_internal libvpx libopus libv8 libsonic libaudioflinger libstagefright% libFFTEm libRSCpuRef \
  libbnnmlowp libmedia_jni libFraunhoferAAC libavcdec libavcenc libmpeg2dec libwebrtc% libmusicbundle libreverb libscrypt_static \
  libmpeg2dec libcrypto_static libcrypto libyuv% libjni_gallery_filters% libjni_gallery_filters_32 libLLVMSelectionDAG
